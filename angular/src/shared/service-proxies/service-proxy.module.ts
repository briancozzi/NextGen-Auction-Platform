...
@NgModule({
    providers: [
        ApiServiceProxies.ApplicationConfigurationsServiceProxy,        
        ...
        ApiServiceProxies.AppAccountServiceProxy,
        ApiServiceProxies.AccountEventServiceProxy,
        ApiServiceProxies.AuctionServiceProxy,
        ApiServiceProxies.ItemServiceProxy,
        ApiServiceProxies.CategoryServiceProxy,
        ApiServiceProxies.AuctionItemServiceProxy,
