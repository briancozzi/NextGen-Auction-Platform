...
using Shouldly;
using Xunit;
using NextGen-Auction-Platform.Sessions;

namespace NextGen-Auction-Platform.Tests.Sessions
{
    public class SessionAppService_Tests : NextGen-Auction-PlatformTestBase
    {
