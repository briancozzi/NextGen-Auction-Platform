...
using NextGen.BiddingPlatform.MultiTenancy.HostDashboard;
...
namespace NextGen.BiddingPlatform.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(BiddingPlatformDbContext context, SubscriptionPayment subscriptionPayment)
        {
