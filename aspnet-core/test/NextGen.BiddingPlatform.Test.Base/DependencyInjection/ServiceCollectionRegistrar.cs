...
namespace NextGen.BiddingPlatform.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<BiddingPlatformDbContext>>()
            ...
            new BiddingPlatformDbContext(builder.Options).Database.EnsureCreated();
        }
