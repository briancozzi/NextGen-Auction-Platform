...
$webMvcFolder = Join-Path $slnFolder "src/NextGen.BiddingPlatform.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/NextGen.BiddingPlatform.Web.Public"
...
dotnet restore NextGen.BiddingPlatform.Web.sln
