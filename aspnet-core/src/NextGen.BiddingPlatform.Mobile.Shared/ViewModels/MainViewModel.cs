...
using NextGen.BiddingPlatform.Services.Navigation;
...
using NextGen.BiddingPlatform.Controls;
using NextGen.BiddingPlatform.Dto;
using NextGen.BiddingPlatform.Extensions;
using NextGen.BiddingPlatform.Localization;
using NextGen.BiddingPlatform.UI;
using NextGen.BiddingPlatform.UI.Assets;
using NextGen.BiddingPlatform.Views;
using DependencyResolver = NextGen.BiddingPlatform.Core.Dependency.DependencyResolver;
...
namespace NextGen.BiddingPlatform.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "BiddingPlatform";
