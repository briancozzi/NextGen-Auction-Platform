...
using NextGen.BiddingPlatform.EntityFrameworkCore.Repositories;

namespace NextGen.BiddingPlatform.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : BiddingPlatformRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<BiddingPlatformDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
