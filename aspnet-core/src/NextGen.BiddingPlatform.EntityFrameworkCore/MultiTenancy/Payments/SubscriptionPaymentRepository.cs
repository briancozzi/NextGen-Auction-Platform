...
{
    public class SubscriptionPaymentRepository : BiddingPlatformRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<BiddingPlatformDbContext> dbContextProvider)
