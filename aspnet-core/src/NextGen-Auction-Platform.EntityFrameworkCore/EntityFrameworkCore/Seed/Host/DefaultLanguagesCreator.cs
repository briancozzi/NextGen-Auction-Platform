...
namespace NextGen-Auction-Platform.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = NextGen-Auction-PlatformConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(NextGen-Auction-PlatformDbContext context)
        {
            _context = context;
        }
