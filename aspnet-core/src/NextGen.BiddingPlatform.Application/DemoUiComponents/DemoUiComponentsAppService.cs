...
using NextGen.BiddingPlatform.DemoUiComponents.Dto;

namespace NextGen.BiddingPlatform.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : BiddingPlatformAppServiceBase, IDemoUiComponentsAppService
    {
