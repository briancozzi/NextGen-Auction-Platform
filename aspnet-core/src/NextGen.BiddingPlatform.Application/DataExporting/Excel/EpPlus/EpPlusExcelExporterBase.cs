...
namespace NextGen.BiddingPlatform.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : BiddingPlatformServiceBase, ITransientDependency
    {
