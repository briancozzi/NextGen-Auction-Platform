...
{
    public class SessionAppService : BiddingPlatformAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = BiddingPlatformConsts.Currency,
                    CurrencySign = BiddingPlatformConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = BiddingPlatformConsts.AllowTenantsToChangeEmailSettings,
