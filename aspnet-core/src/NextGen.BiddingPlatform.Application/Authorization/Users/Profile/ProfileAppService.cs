...
namespace NextGen.BiddingPlatform.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : BiddingPlatformAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("NextGen.BiddingPlatform",
