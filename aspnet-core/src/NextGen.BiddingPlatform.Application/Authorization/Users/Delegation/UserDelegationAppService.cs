...
namespace NextGen.BiddingPlatform.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : BiddingPlatformAppServiceBase, IUserDelegationAppService
    {
