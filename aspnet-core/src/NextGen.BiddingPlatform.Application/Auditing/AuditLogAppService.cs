...
using EntityHistoryHelper = NextGen.BiddingPlatform.EntityHistory.EntityHistoryHelper;

namespace NextGen.BiddingPlatform.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : BiddingPlatformAppServiceBase, IAuditLogAppService
    {
