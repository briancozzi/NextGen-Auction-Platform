...
using NextGen.BiddingPlatform.DynamicEntityPropertyValues.Dto;
...
namespace NextGen.BiddingPlatform.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : BiddingPlatformAppServiceBase, IDynamicEntityPropertyValueAppService
    {
