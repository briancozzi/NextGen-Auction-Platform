...
namespace NextGen.BiddingPlatform.Web.Authentication.JwtBearer
{
    public class BiddingPlatformJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public BiddingPlatformJwtSecurityTokenHandler()
        {
