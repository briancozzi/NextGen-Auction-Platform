...
namespace NextGen.BiddingPlatform.Web.Security.Recaptcha
{
    public class RecaptchaValidator : BiddingPlatformServiceBase, IRecaptchaValidator, ITransientDependency
    {
