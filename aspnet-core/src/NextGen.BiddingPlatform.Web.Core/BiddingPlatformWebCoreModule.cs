...
using NextGen.BiddingPlatform.Web.Configuration;
using NextGen.BiddingPlatform.Web.DashboardCustomization;
...
namespace NextGen.BiddingPlatform.Web
{
    ...
    public class BiddingPlatformWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public BiddingPlatformWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BiddingPlatformWebCoreModule).GetAssembly());
        }
