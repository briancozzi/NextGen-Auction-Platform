...
{
    [DependsOn(
        typeof(BiddingPlatformWebCoreModule)
    )]
    public class BiddingPlatformWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public BiddingPlatformWebFrontEndModule(IWebHostEnvironment env, BiddingPlatformEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BiddingPlatformWebFrontEndModule).GetAssembly());
        }
    }
}
