...
{
    public class StripeGatewayManager : BiddingPlatformServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "BiddingPlatform";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + BiddingPlatformConsts.Currency;
        }
