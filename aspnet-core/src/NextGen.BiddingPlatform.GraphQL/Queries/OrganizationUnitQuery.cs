...
using NextGen.BiddingPlatform.Core.Base;
...
{
    public class OrganizationUnitQuery : BiddingPlatformQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
