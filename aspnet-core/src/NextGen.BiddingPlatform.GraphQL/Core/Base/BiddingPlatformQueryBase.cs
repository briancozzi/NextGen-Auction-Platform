...
namespace NextGen.BiddingPlatform.Core.Base
{
    public abstract class BiddingPlatformQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected BiddingPlatformQueryBase(string fieldName,
