...
using NextGen.BiddingPlatform.Web.Startup.ExternalLoginInfoProviders;
...
namespace NextGen.BiddingPlatform.Web.Startup
{
    ...
    public class BiddingPlatformWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public BiddingPlatformWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BiddingPlatformWebHostModule).GetAssembly());
        }
